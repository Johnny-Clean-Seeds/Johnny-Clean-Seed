...
Write-Host "=== ROOT HELD GROUP ROUTE OR HOLD DECISION OPTION SET V0_2 STOPLINE_FIX_V0_2 ==="
...
$OptionRows = @(
    ...
    [pscustomobject]@{
        ...
        DoesNotDo = "No move, delete, route, execute, commit, or push is allowed from this option-set card"
