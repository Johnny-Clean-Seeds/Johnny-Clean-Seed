...
Write-Host "=== ROOT HELD GROUP READ ONLY PREP CARD V0_2 WITH STRESS BENCH RUNNER_FIX_V0_3 ==="
...
$ReportLineArray = @($ReportLines | ForEach-Object { [string]$_ })
$ParsedRows = @(Parse-CorrectPrepTableRows -Lines $ReportLineArray)
