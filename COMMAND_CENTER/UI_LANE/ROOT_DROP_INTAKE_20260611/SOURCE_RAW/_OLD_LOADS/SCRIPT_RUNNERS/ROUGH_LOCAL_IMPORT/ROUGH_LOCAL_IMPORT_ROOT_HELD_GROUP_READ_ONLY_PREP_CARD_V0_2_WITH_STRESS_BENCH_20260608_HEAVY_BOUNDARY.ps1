...
Write-Host "=== ROUGH_LOCAL IMPORT: ROOT HELD GROUP READ ONLY PREP CARD V0_2 WITH STRESS BENCH ==="
...
$RequiredPrepSignals = @(
    ...
    "PREP_CARD_ROW_SHA_INTERPOLATION_BUG",
...
$RoughLedgerLines = @(
    ...
    "",
    "Status: ROUGH_LOCAL_POINTER_LEDGER / SUPERSEDES_BAD_SHA_TABLE / STRESS_BENCH_CONFIRMED / GIT_IMPORT_PACKET / NOT_FULL_LOCAL_EVIDENCE / NOT_CLEANUP_ORDER / NOT_ROUTE_ORDER / NOT_DOCTRINE",
    "Created: $Now",
