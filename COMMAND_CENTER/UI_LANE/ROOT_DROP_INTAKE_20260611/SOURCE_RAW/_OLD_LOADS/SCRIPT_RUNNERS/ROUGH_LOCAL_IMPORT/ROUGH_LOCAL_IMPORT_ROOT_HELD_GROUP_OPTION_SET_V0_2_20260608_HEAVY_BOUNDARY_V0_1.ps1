...
Write-Host "=== ROUGH_LOCAL IMPORT: ROOT HELD GROUP OPTION SET V0_2 ==="
...
$RoughLedgerLines = @(
    ...
    "",
    "Status: ROUGH_LOCAL_POINTER_LEDGER / OPTION_SET / USER_DECISION_SURFACE / STRESS_BENCH_CONFIRMED / GIT_IMPORT_PACKET / NOT_FULL_LOCAL_EVIDENCE / NOT_CLEANUP_ORDER / NOT_ROUTE_ORDER / NOT_DOCTRINE",
    "Created: $Now",
