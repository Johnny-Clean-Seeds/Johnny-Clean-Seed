...
Write-Host "XxXxX ===== TODO WEAKEST-LINK TRIAGE READ START ===== XxXxX"
...
$Ranked = @($Rows | Sort-Object Score -Descending, Modified -Descending)
$Groups = $Rows | Group-Object ParentBoss | Sort-Object Count -Descending

Write-Host ""
Write-Host "XxXxX ===== COPY BLOCK TO CHAT START ===== XxXxX"
Write-Host "TODO WEAKEST-LINK TRIAGE READ"
