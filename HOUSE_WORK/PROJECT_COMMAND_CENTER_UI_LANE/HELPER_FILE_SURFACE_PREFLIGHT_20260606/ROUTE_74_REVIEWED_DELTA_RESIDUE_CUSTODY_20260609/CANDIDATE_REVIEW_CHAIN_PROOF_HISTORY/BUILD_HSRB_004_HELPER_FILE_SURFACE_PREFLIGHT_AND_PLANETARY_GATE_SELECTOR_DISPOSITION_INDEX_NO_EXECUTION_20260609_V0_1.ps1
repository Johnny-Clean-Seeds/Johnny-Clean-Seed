...
$verdict = if ($contractGatePassed) { 'HSRB_004_HELPER_FILE_SURFACE_PREFLIGHT_AND_PLANETARY_GATE_SELECTOR_DISPOSITION_INDEX_V0_1_WRITTEN_WITH_REVIEW_ONLY_GIT_MARKERS_NO_PHYSICAL_ACTION' } else { 'HSRB_004_HELPER_FILE_SURFACE_PREFLIGHT_AND_PLANETARY_GATE_SELECTOR_DISPOSITION_INDEX_V0_1_WRITTEN_WITH_BLOCKERS_NO_PHYSICAL_ACTION' }

$outCsv = Join-Path $Base 'HSRB_004_HELPER_FILE_SURFACE_PREFLIGHT_AND_PLANETARY_GATE_SELECTOR_DISPOSITION_INDEX_NO_EXECUTION_V0_1_20260609.csv'
$outMd = Join-Path $Base 'HSRB_004_HELPER_FILE_SURFACE_PREFLIGHT_AND_PLANETARY_GATE_SELECTOR_DISPOSITION_INDEX_NO_EXECUTION_V0_1_20260609.md'
$outPrint = Join-Path $Base 'HSRB_004_HELPER_FILE_SURFACE_PREFLIGHT_AND_PLANETARY_GATE_SELECTOR_DISPOSITION_INDEX_NO_EXECUTION_COPY_PRINT_V0_1_20260609.txt'
$outReceipt = Join-Path $Base 'HSRB_004_HELPER_FILE_SURFACE_PREFLIGHT_AND_PLANETARY_GATE_SELECTOR_DISPOSITION_INDEX_NO_EXECUTION_RECEIPT_V0_1_20260609.txt'

$indexRowsArray | Export-Csv -LiteralPath $outCsv -NoTypeInformation -Encoding UTF8
$outCsvSha = Get-Sha256 $outCsv

$md = New-Object System.Collections.Generic.List[string]
[void]$md.Add('# HSRB-004 Helper File Surface Preflight and Planetary Gate Selector Disposition Index - No Execution - V0.1')
[void]$md.Add('')
...
[void]$receipt.Add('HSRB-004 HELPER FILE SURFACE PREFLIGHT AND PLANETARY GATE SELECTOR DISPOSITION INDEX RECEIPT V0.1')
...
Write-Output '=== HSRB-004 HELPER FILE SURFACE PREFLIGHT AND PLANETARY GATE SELECTOR DISPOSITION INDEX V0.1 COMPLETE ==='
