...
Purpose: Repair HSRB-005 contract-first static review decision closeout after V0.1 blocker verdict.
Scope: NO EXECUTION / NO ROUTE / NO CLEANUP / NO COMMIT / NO PUSH.
Repair class: contract semantics repair plus actual SHA field repair.
...
$FixNotePath = Join-Path $Lane 'FIX_NOTE__HSRB_005_STATIC_REVIEW_DECISION_CLOSEOUT_V0_2_ACTUAL_SHA_AND_RISK_CONTRACT_REPAIR_20260609.md'
$FixReceiptPath = Join-Path $Lane 'HASH_RECEIPT__HSRB_005_STATIC_REVIEW_DECISION_CLOSEOUT_V0_2_REPAIR_20260609.txt'

$OutputRiskCsvPath = Join-Path $Lane 'HSRB_005_STATIC_REVIEW_DECISION_CLOSEOUT_CONTRACT_FIRST_RISK_MARKER_INDEX_V0_2_20260609.csv'
$OutputCloseoutPath = Join-Path $Lane 'HSRB_005_STATIC_REVIEW_DECISION_CLOSEOUT_CONTRACT_FIRST_NO_EXECUTION_V0_2_20260609.md'
$OutputCloseoutPrintPath = Join-Path $Lane 'HSRB_005_STATIC_REVIEW_DECISION_CLOSEOUT_CONTRACT_FIRST_NO_EXECUTION_COPY_PRINT_V0_2_20260609.txt'
$OutputReceiptPath = Join-Path $Lane 'HSRB_005_STATIC_REVIEW_DECISION_CLOSEOUT_CONTRACT_FIRST_NO_EXECUTION_RECEIPT_V0_2_20260609.txt'
...
$fixNoteLines = @(
    '# FIX NOTE — HSRB-005 STATIC REVIEW DECISION CLOSEOUT V0.2',
    '',
    'Status: FIX_NOTE / CONTRACT_SEMANTIC_REPAIR / NO_PHYSICAL_ACTION',
    '',
    'V0.2 repairs two defect classes from V0.1:',
...
$finalVerdict = if ($contractGatePassed) { 'HSRB_005_STATIC_REVIEW_DECISION_CLOSEOUT_V0_2_CONTRACT_FIRST_WRITTEN_WITH_CLASSIFIED_REVIEW_ONLY_HIGH_RISK_MARKERS_NO_PHYSICAL_ACTION' } else { 'HSRB_005_STATIC_REVIEW_DECISION_CLOSEOUT_V0_2_WRITTEN_WITH_BLOCKERS_NO_PHYSICAL_ACTION' }

$closeoutLines = @(
    '# HSRB-005 Static Review Decision Closeout Contract First V0.2',
    '',
...
$receiptLines = @(
    'HSRB-005 STATIC REVIEW DECISION CLOSEOUT CONTRACT FIRST V0.2 RECEIPT',
    "v0_1_error_freeze_path: $V01ErrorFreezePath",
    "v0_1_error_freeze_sha256: $v01ErrorFreezeSha",
    "fix_note_path: $FixNotePath",
    "fix_note_sha256: $fixNoteSha",
...
Write-Host '=== HSRB-005 STATIC REVIEW DECISION CLOSEOUT CONTRACT FIRST V0.2 COMPLETE ==='
