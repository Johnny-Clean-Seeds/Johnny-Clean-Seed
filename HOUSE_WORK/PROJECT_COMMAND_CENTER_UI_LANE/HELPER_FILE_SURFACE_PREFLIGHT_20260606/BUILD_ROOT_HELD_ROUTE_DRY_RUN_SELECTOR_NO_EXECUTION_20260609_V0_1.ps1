...
$ReportPath = Join-Path $Base ("DRY_RUN__ROOT_HELD_ROUTE_SELECTOR_REPORT_20260609_V0_1_{0}.md" -f $RunStamp)
$RowsCsvPath = Join-Path $Base ("DRY_RUN__ROOT_HELD_ROUTE_SELECTOR_ROWS_20260609_V0_1_{0}.csv" -f $RunStamp)
$DeltaCsvPath = Join-Path $Base ("DRY_RUN__ROOT_HELD_ROUTE_SELECTOR_LIVE_ROOT_DELTA_20260609_V0_1_{0}.csv" -f $RunStamp)
$CollisionCsvPath = Join-Path $Base ("DRY_RUN__ROOT_HELD_ROUTE_SELECTOR_COLLISIONS_20260609_V0_1_{0}.csv" -f $RunStamp)
$ReceiptPath = Join-Path $Base ("HASH_RECEIPT__ROOT_HELD_ROUTE_SELECTOR_DRY_RUN_20260609_V0_1_{0}.txt" -f $RunStamp)
$FreezePath = Join-Path $Base ("FREEZE__ROOT_HELD_ROUTE_SELECTOR_DRY_RUN_FAILURE_20260609_V0_1_{0}.md" -f $RunStamp)
