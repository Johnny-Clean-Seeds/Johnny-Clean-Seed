# TODO — Chat Handoff Checkpoint Rope Carry Next Use

Date: 2026-05-30
RunId: 20260530_003810
WorkKey: KEY_2E6F99ED9EFE
Status: TODO / NEXT USE

When moving chats, use the final packet/checkpoint instead of dragging dead chat.

Carry:

- latest HEAD / origin / clean status
- active object
- active rope
- active soft suits
- latest saved rule/package names
- local drop-copy path
- next exact command
- blocked actions
- reopen triggers

<!-- LIVING_OBJECT_REGISTRY_V2_FIRST_WAVE_REPAIR:F4BE3094859BDD35 -->
...
Object path: HOUSE_WORK/TODO/CHAT_HANDOFF_CHECKPOINT_ROPE_CARRY_NEXT_USE_TODO_20260530.md
...
Target: HOUSE_WORK/TODO/CHAT_HANDOFF_CHECKPOINT_ROPE_CARRY_NEXT_USE_TODO_20260530.md
...
<!-- LIVING_OBJECT_REGISTRY_V2_FIRST_WAVE_REPAIR:85E3E155E0E7F2EF -->
## Living Object Registry V2 — First-Wave Bounded Repair Note
