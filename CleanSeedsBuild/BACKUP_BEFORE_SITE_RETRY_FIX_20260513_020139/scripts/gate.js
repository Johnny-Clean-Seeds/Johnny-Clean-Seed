(() => {
  ...
  function buildReadme() {
    return [
      ...
      '+======================================+',
      '',
      'This page is a public reader for the Clean Seed model notes and file summaries.',
      '',
      'Use the group buttons to narrow the file list.',
      'Use search when you already know a word, filename, or hash.',
      'Choose View to stream a file into the page.',
      'Choose Copy when you want the selected text on your clipboard.',
      'Use Download Selected File only after opening the file you want.',
      '',
      'Public safety rule:',
      'Exact local machine paths are removed from the public file copies.'
    ].join('\n');
  }
  ...
  function initializeApp() {
    ...
    if (startFile) {
      ...
      setOutput('viewer', 'No public data files are listed.');
    }
  }
  ...
  function handleFileListClick(event) {
    ...
    if (control.dataset.action === 'load') openFile(file);
