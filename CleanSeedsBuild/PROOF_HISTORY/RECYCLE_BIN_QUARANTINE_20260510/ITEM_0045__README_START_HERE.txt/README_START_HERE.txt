...
Package patch ID:
CLEAN_SEED_PATCH_2026_05_08_ORDERED_MULTIFIX_TRUE_CONTINUE
...
Issue status:
Pending issues: yes / no / unsure
Action needed: yes / no / optional
Next clean move: [one short line]
If unsure: ask the assistant to inspect the pending issue before continuing.
